    ...
    <div className="min-h-screen bg-gray-50 flex flex-col pb-12">
      <div className="bg-[#001f3f] p-6 pt-12 pb-8 rounded-b-[40px] relative overflow-hidden flex-shrink-0">
        ...
        <div className="flex items-center justify-between mb-6 relative z-10">
          <button type="button" aria-label="Go back" onClick={() => navigateTo('welcome')} className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-md">
      ...
      <div className="p-6 flex flex-col gap-8 flex-1 overflow-y-auto no-scrollbar">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white p-6 rounded-[32px] shadow-sm border border-gray-50 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 w-full">
              <label htmlFor="food-category" className="text-xs font-bold text-[#001f3f] uppercase tracking-wider">Food Category</label>
              <div className="relative">
                <select id="food-category" className="w-full bg-gray-100 border-none rounded-2xl py-4 pl-6 pr-12 focus:ring-2 focus:ring-[#C1121F] transition-all outline-none text-gray-800 appearance-none font-medium">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white p-6 rounded-[32px] shadow-sm border border-gray-50 grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-2 w-full">
              <label htmlFor="opening-time" className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Opening Time</label>
              <div className="relative">
                <select id="opening-time" className="w-full bg-gray-100 border-none rounded-2xl py-4 pl-4 pr-10 focus:ring-2 focus:ring-[#C1121F] outline-none text-[#001f3f] font-bold appearance-none">
            ...
            <div className="flex flex-col gap-2 w-full">
              <label htmlFor="closing-time" className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Closing Time</label>
              <div className="relative">
                <select id="closing-time" className="w-full bg-gray-100 border-none rounded-2xl py-4 pl-4 pr-10 focus:ring-2 focus:ring-[#C1121F] outline-none text-[#001f3f] font-bold appearance-none">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white p-6 rounded-[32px] shadow-sm border border-gray-50 flex flex-col gap-4">
            <div className="flex flex-col gap-2 w-full">
              <label htmlFor="bank-name" className="text-xs font-bold text-[#001f3f] uppercase tracking-wider">Bank Name</label>
              <div className="relative">
                <select id="bank-name" className="w-full bg-gray-100 border-none rounded-2xl py-4 pl-6 pr-12 focus:ring-2 focus:ring-[#C1121F] transition-all outline-none text-gray-800 appearance-none font-medium">
        ...
        <div className="mt-4 flex flex-col items-center gap-4">
          <Button variant="primary" onClick={() => navigateTo('vendor_application_submitted')} className="w-full h-16 text-lg font-black italic shadow-red-900/30">
            Submit Application
          </Button>
