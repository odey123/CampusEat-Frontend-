  ...
  <div className="min-h-screen bg-gray-50 pb-32">
    ...
    <div className="p-6 flex flex-col gap-8">
      <div className="bg-white p-6 rounded-[32px] flex items-center gap-4 shadow-sm border border-gray-50">
        ...
        <button className="text-[#C1121F] font-black text-sm">Change</button>
      </div>
          ...
          <div key={item.id} className="bg-white p-4 rounded-2xl flex items-center justify-between shadow-sm">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-3 bg-gray-100 px-3 py-1.5 rounded-full">
                ...
                <button onClick={() => addToCart(item)} className="text-[#C1121F]"><Plus className="w-4 h-4" /></button>
              </div>
      ...
      <div className="flex gap-3">
        ...
        <button className="bg-[#C1121F] text-white px-8 py-4 rounded-2xl font-bold text-sm">Apply</button>
      </div>

      <h3 className="text-xl font-black text-[#001f3f]">Payment Method</h3>
      <div className="grid grid-cols-2 gap-4">
        <button className="bg-white border-2 border-[#C1121F] rounded-[32px] p-6 flex flex-col items-center gap-3 relative">
